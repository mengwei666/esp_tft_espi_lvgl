...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_1_btn_1_label, "back2");
	...
	lv_obj_set_pos(ui->screen_1_btn_1, 131, 184);
	...
	lv_label_set_text(ui->screen_1_btn_2_label, "back1");
	...
	lv_obj_set_pos(ui->screen_1_btn_2, 131, 118);
	...
	lv_obj_set_style_bg_color(ui->screen_1_btn_2, lv_color_hex(0x14202b), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_1_btn_3_label, "Button");
	...
	lv_obj_set_pos(ui->screen_1_btn_3, 131, 49);
