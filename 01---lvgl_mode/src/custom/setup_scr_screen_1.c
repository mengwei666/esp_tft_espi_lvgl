...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_1_btn_1_label, "Button_1");
	...
	lv_obj_set_pos(ui->screen_1_btn_1, 75, 146);
	...
	lv_obj_set_style_bg_color(ui->screen_1_btn_1, lv_color_hex(0x00ffa1), LV_PART_MAIN|LV_STATE_DEFAULT);
